        ...
        <div class="container-fluid">
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div ng-controller="DepController as objCtrl">
                            <h1 class="text-warning">Department Info</h1><br>
                            <form name="objForm" method="POST">
                                <table class="table">
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <h4 class="text-primary">Add New Department</h4>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <h4 class="text-primary">Update Department For ID: {{objCtrl.obj.depId}}</h4>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="td_border">
                                            <input type="text" name="depName" ng-model="objCtrl.obj.depName" required/>
                                            <span ng-show="objForm.depName.$error.required" class="msg-val">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Faculty:</td>
                                        <td class="td_border">
                                            <select ng-model="objCtrl.obj.faculty" ng-options="y.facName for y in facs"></select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Title:</td>
                                        <td class="td_border">
                                            <input type="text" name="depTitle" ng-model="objCtrl.obj.depTitle"/>
                                            <span class="msg-val text-info">(If have any)</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Sub-Title:</td>
                                        <td class="td_border">
                                            <input type="text" name="depSubTitle" ng-model="objCtrl.obj.depSubTitle"/>
                                            <span class="msg-val text-info">(If have any)</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Description:</td>
                                        <td class="td_border">
                                            <input type="text" name="depDesc" ng-model="objCtrl.obj.depDesc"/>
                                            <span class="msg-val text-info">(If have any)</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <span ng-if="objCtrl.flag == 'created'" class="msg-success text-info">Department Successfully Added.</span>
                                            <span ng-if="objCtrl.flag == 'failed'" class="msg-val text-danger">Department already exists.</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border" style="padding-left: 280px">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <input type="submit" class="text-success" ng-click="objCtrl.addObject()" value="Add Department"/> 
                                                <input type="button" class="text-success" ng-click="objCtrl.reset()" value="Reset"/>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <input  type="submit" class="text-success" ng-click="objCtrl.updateObjectDetail()" value="Update Department"/> 	
                                    ...
                                    <tr>
                                        <td colspan="2" class="td_border"> 
                                            <span ng-if="objCtrl.flag == 'deleted'" class="msg-success">Department successfully deleted.</span>
                                        </td>   
                                    </tr>
                                </table>
                            </form>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr ng-repeat="row in objCtrl.objArray"  class="table-light">
                                    <td><span ng-bind="row.depId"></span></td>
                                    <td><span ng-bind="row.depName"></span></td>
                                    <td><span ng-bind="row.faculty.facName"></span></td>
                                    <td>
                                        <input type="button" ng-click="objCtrl.deleteObject(row.depId)" value="Delete" style="padding-left: 10px"/>
                                        <input type="button" ng-click="objCtrl.editObject(row.depId)" value="Edit"/>
                                        <span ng-if="objCtrl.flag == 'updated' && row.depId == objCtrl.updatedId" class="msg-success text-info">Department successfully updated.</span>
                                    </td> 
                                </tr>	
                            </table>
                        </div>
