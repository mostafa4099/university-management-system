        ...
        <div class="container-fluid">
            <div>
                                    ...
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item active" href="${pageContext.request.contextPath}/fac/home">Faculty</a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div ng-controller="FacController as objCtrl">
                            <h1 class="text-warning">Faculty Info</h1><br>
                            <form name="objForm" method="POST">
                                <table class="table">
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <h4 class="text-primary">Add New Faculty</h4>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <h4 class="text-primary">Update Faculty For ID: {{objCtrl.obj.facId}}</h4>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="td_border">
                                            <input type="text" name="facName" ng-model="objCtrl.obj.facName" required/>
                                            <span ng-show="objForm.facName.$error.required" class="msg-val">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Title:</td>
                                        <td class="td_border">
                                            <input type="text" name="facTitle" ng-model="objCtrl.obj.facTitle"/>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td_border">
                                            <input type="text" name="facSubTitle" ng-model="objCtrl.obj.facSubTitle"/>
                                            <span class="msg-val text-info">(If have any)</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="td_border">
                                            <input type="text" name="facDesc" ng-model="objCtrl.obj.facDesc"/>
                                            <span class="msg-val text-info">(If have any)</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <span ng-if="objCtrl.flag == 'created'" class="msg-success text-info">Faculty Successfully Added.</span>
                                            <span ng-if="objCtrl.flag == 'failed'" class="msg-val text-danger">Faculty already exists.</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border" style="padding-left: 280px">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <input type="submit" class="text-success" ng-click="objCtrl.addObject()" value="Add Faculty"/> 
                                                <input type="button" class="text-success" ng-click="objCtrl.reset()" value="Reset"/>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <input  type="submit" class="text-success" ng-click="objCtrl.updateObjectDetail()" value="Update Faculty"/> 	
                                    ...
                                    <tr>
                                        <td colspan="2" class="td_border"> 
                                            <span ng-if="objCtrl.flag == 'deleted'" class="msg-success">Faculty successfully deleted.</span>
                                        </td>   
                                    </tr>
                                </table>
                            </form>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr ng-repeat="row in objCtrl.objArray"  class="table-light">
                                    <td><span ng-bind="row.facId"></span></td>
                                    <td><span ng-bind="row.facName"></span></td>
                                    <td>
                                        <input type="button" ng-click="objCtrl.deleteObject(row.facId)" value="Delete" style="padding-left: 10px"/>
                                        <input type="button" ng-click="objCtrl.editObject(row.facId)" value="Edit"/>
                                        <span ng-if="objCtrl.flag == 'updated' && row.facId == objCtrl.updatedId" class="msg-success text-info">Faculty successfully updated.</span>
                                    </td> 
                                </tr>	
                            </table>
                        </div>
