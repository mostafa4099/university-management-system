                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div ng-controller="NoticeController as objCtrl">
                            <h1 class="text-warning">Notice Info</h1><br>
                            <form name="objForm" method="POST">
                                <table class="table">
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <h4 class="text-primary">Add New Notice</h4>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <h4 class="text-primary">Update Notice For ID: {{objCtrl.obj.noticeId}}</h4>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Category:</td>
                                        <td class="td_border">
                                            <select ng-model="objCtrl.obj.noticeCategory" ng-options="x.ncatName for x in names"></select>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Heading:</td>
                                        <td class="td_border">
                                            <input type="text" name="heading" ng-model="objCtrl.obj.heading" required/>
                                            <span ng-show="objForm.heading.$error.required" class="msg-val">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                       <td class="insert_field td_border">Main Content:</td>
                                        <td class="td_border">
                                            <input type="text" name="mainContent" ng-model="objCtrl.obj.mainContent" required/>
                                            <span ng-show="objForm.mainContent.$error.required" class="msg-val">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">End Date:</td>
                                        <td class="td_border">
                                            <input type="date" name="endDate" ng-model="objCtrl.obj.endDate" required/>
                                            <span ng-show="objForm.endDate.$error.required" class="msg-val">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <span ng-if="objCtrl.flag == 'created'" class="msg-success text-info">Notice Successfully Added.</span>
                                            <span ng-if="objCtrl.flag == 'failed'" class="msg-val text-danger">Notice already exists.</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border" style="padding-left: 280px">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <input type="submit" class="text-success" ng-click="objCtrl.addObject()" value="Add Notice"/> 
                                                <input type="button" class="text-success" ng-click="objCtrl.reset()" value="Reset"/>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <input  type="submit" class="text-success" ng-click="objCtrl.updateObjectDetail()" value="Update Notice"/> 	
                            ...
                            <table class="table table-hover">
                                ...
                                <tr ng-repeat="row in objCtrl.objArray"  class="table-light">
                                    <td><span ng-bind="row.noticeId"></span></td>
                                    <td><span ng-bind="row.noticeCategory.ncatName"></span></td>
                                    <td><span ng-bind="row.heading"></span></td>
                                    <td><span ng-bind="row.publishDate"></span></td>
                                    <td><span ng-bind="row.endDate"></span></td>
                                    <td>
                                        <input type="button" ng-click="objCtrl.deleteObject(row.noticeId)" value="Delete" style="padding-left: 10px"/>
                                        <input type="button" ng-click="objCtrl.editObject(row.noticeId)" value="Edit"/>
                                        <span ng-if="objCtrl.flag == 'updated' && row.noticeId == objCtrl.updatedId" class="msg-success text-info">Notice successfully updated.</span>
                                    </td> 
                                </tr>	
                            </table>
                        </div>
