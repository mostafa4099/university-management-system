        ...
        <div class="container-fluid">
            <div>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav mr-auto">
                                            ...
                                            <div class="dropdown-menu mega-menu meg-col-4" aria-labelledby="navbarDropdown">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/salary/home" class="dropdown-item">Pay Salary</a></p>
                                            ...
                                            <div class="dropdown-menu mega-menu meg-col-4" aria-labelledby="navbarDropdown">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/student/home" class="dropdown-item">Add Student</a></p>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/assigne/home" class="dropdown-item">Assign Student</a></p>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/fee/home" class="dropdown-item">Receive Fees</a></p>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="${pageContext.request.contextPath}/sub/home">Add Subject</a>
                                            ...
                                            <div class="dropdown-menu mega-menu meg-col-6" aria-labelledby="navbarDropdown">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/exam/home" class="dropdown-item">Add Exam</a></p>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/schedule/home" class="dropdown-item">Add Exam Schedule</a></p>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="${pageContext.request.contextPath}/routine/home">Add Routine</a>
                                            ...
                                            <div class="dropdown-menu mega-menu meg-col-4" aria-labelledby="navbarDropdown">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/subres/home" class="dropdown-item">Add Result</a></p>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/semres/home" class="dropdown-item">Add Result</a></p>
                                                        <p><a href="#" class="dropdown-item">Check Result</a></p>
                                                        <p><a href="#" class="dropdown-item">Update Result</a></p>
                                                        <p><a href="#" class="dropdown-item">Remove Result</a></p>
                                                    </div>
                                                    <div class="col-md-4">
                                                        ...
                                                        <p><a href="${pageContext.request.contextPath}/finalres/home" class="dropdown-item">Add Result</a></p>
                                                        <p><a href="#" class="dropdown-item">Check Result</a></p>
                                                        <p><a href="#" class="dropdown-item">Update Result</a></p>
                                                        <p><a href="#" class="dropdown-item">Remove Result</a></p>
                                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <h2 class="text-warning">Hello Admin!</h2>
