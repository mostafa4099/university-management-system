        ...
        <div class="container-fluid">
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div ng-controller="NcatController as objCtrl">
                            <h1 class="text-warning">Notice Category Info</h1><br>
                            <form name="objForm" method="POST">
                                <table class="table">
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <h4 class="text-primary">Add New Notice Category</h4>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <h4 class="text-primary">Update Notice Category For ID: {{objCtrl.obj.ncatId}}</h4>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Category Name:</td>
                                        <td class="td_border">
                                            <input type="text" name="ncatName" ng-model="objCtrl.obj.ncatName" required/>
                                            <span ng-show="objForm.ncatName.$error.required" class="msg-val">*</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <span ng-if="objCtrl.flag == 'created'" class="msg-success text-info">Notice Category Successfully Added.</span>
                                            <span ng-if="objCtrl.flag == 'failed'" class="msg-val text-danger">Notice Category already exists.</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border" style="padding-left: 280px">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <input type="submit" class="text-success" ng-click="objCtrl.addObject()" value="Add Category"/> 
                                                <input type="button" class="text-success" ng-click="objCtrl.reset()" value="Reset"/>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <input  type="submit" class="text-success" ng-click="objCtrl.updateObjectDetail()" value="Update Category"/> 	
                                    ...
                                    <tr>
                                        <td colspan="2" class="td_border"> 
                                            <span ng-if="objCtrl.flag == 'deleted'" class="msg-success">Notice Category successfully deleted.</span>
                                        </td>   
                                    </tr>
                                </table>
                            </form>
                            ...
                            <table class="table table-hover">
                                ...
                                <tr ng-repeat="row in objCtrl.objArray"  class="table-light">
                                    <td><span ng-bind="row.ncatId"></span></td>
                                    <td><span ng-bind="row.ncatName"></span></td>
                                    <td>
                                        <input type="button" ng-click="objCtrl.deleteObject(row.ncatId)" value="Delete" style="padding-left: 10px"/>
                                        <input type="button" ng-click="objCtrl.editObject(row.ncatId)" value="Edit"/>
                                        <span ng-if="objCtrl.flag == 'updated' && row.ncatId == objCtrl.updatedId" class="msg-success text-info">Notice Category successfully updated.</span>
                                    </td> 
                                </tr>	
                            </table>
                        </div>
