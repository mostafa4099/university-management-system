            ...
            <div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <form:form method="POST" action="singleMonthSalaryByIdReport" commandName="reportInputForm">
                            ...
                            <table id="reptbl" width="350px" border="1">
                                ...
                                <tr>
                                    <td>
                                        Enter Employee Id <form:input path="id" id="id"/><br>
                                        Enter Payment Month <form:input path="name" id="name" type="date"/><br>
