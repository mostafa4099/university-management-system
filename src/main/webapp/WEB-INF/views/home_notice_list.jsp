...
<html lang="en">
    <head>
        ...
        <script src="${pageContext.request.contextPath}/static/js/controller/notice_list_contoller.js" type="text/javascript"></script>
        <link href="${pageContext.request.contextPath}/static/css/style.css" rel="stylesheet" type="text/css"/>
        <title>Notice</title>
    </head>
    <body ng-app="myApp">
        <div class="container-fluid" ng-controller="NoticeListController as objCtrl">
            <div>
                <div>
                    <div class="row">
                        <div class="col-sm-12">
                                    ...
                                    <ul class="navbar-nav mr-auto">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="#"  ng-repeat="row in objCtrl.objArray2">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="${pageContext.request.contextPath}/nbc/home"  ng-repeat="row in objCtrl.objArray3" ng-click="objCtrl.fetchNoticeByMenu(row.ncatId)">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="${pageContext.request.contextPath}/user/home"><i class="fas fa-user-plus"></i> Registration</a>
                                            </div>
                                        </li>
                                    </ul>
                        ...
                        <div>
                            ...
                            <table>
                                ...
                                <tr ng-repeat="row in objCtrl.objArray">
                                    ...
                                    <td style="white-space:pre"><span ng-bind="row.heading"></span></td>
