                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div ng-controller="TeacherController as objCtrl">
                            <h1 class="text-warning">Teacher Info</h1>
                            <form name="objForm" method="POST">
                                <table class="table">
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <h3 class="text-primary">Add New Teacher</h3>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <h3 class="text-primary">Update Teacher For ID: {{objCtrl.obj.teacherId}}</h3>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="insert_field td_border">Employee Id:</td>
                                        <td class="td_border">
                                    ...
                                    <tr>
                                        <td class="insert_field td_border">Department:</td>
                                        <td class="td_border">
                                    ...
                                    <tr>
                                        <td colspan="2" class="td_border">
                                            <span ng-if="objCtrl.flag == 'created'" class="msg-success text-info">Teacher Successfully Added.</span>
                                            <span ng-if="objCtrl.flag == 'failed'" class="msg-val text-danger">Teacher already exists.</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="td_border" style="padding-left: 280px">
                                            <div ng-if="objCtrl.flag != 'edit'">
                                                <input  type="submit" class="text-success" ng-click="objCtrl.addObject()" value="Add Teacher"/> 
                                                <input type="button" class="text-success" ng-click="objCtrl.reset()" value="Reset"/>
                                            </div>
                                            <div ng-if="objCtrl.flag == 'edit'">
                                                <input  type="submit" class="text-success" ng-click="objCtrl.updateObjectDetail()" value="Update Teacher"/> 	
                            ...
                            <table class="table table-hover">
                                ...
                                <tr ng-repeat="row in objCtrl.objArray" class="table-light">
                                    <td><span ng-bind="row.teacherId"></span></td>
                                    <td><span ng-bind="row.empInfo.empId"></span></td>
                                    <td><span ng-bind="row.empInfo.empName"></span></td>
                                    <td><span ng-bind="row.empInfo.designation.desigName"></span></td>
                                    <td><span ng-bind="row.department.depName"></span></td>
                                    <td><span ng-bind="row.empInfo.empPic"></span></td>
                                    <td>
                                        ...
                                        <span ng-if="objCtrl.flag == 'updated' && row.teacherId == objCtrl.updatedId" class="msg-success text-info">Teacher successfully updated.</span>
                                    </td> 
                                </tr>	
                            </table>
                        </div>
