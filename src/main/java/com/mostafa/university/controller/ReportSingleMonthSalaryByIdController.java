 ...
 */
@Controller
public class ReportSingleMonthSalaryByIdController {

    @RequestMapping(value = "/singleMonthSalaryByIdReport", method = RequestMethod.GET)
    public String loadSurveyPg(
        ...
        return "report_single_month_salary_By_id";
    }
    @RequestMapping(value = "/singleMonthSalaryByIdReport", method = RequestMethod.POST)
    public String generateReport(@ModelAttribute("reportInputForm") ReportInputForm reportInputForm,HttpServletRequest request,HttpServletResponse response) throws JRException, IOException, SQLException, NamingException {
        String reportFileName = "singleMonthSalaryById";
        ...
        try {
            ...
            String name = reportInputForm.getName();

            HashMap<String, Object> hmParams = new HashMap<String, Object>();

            hmParams.put("empId", id);
            hmParams.put("paymentMonth", name);
